"""
Django settings for dwg_testing_48702 project.
...
ROOT_URLCONF = 'dwg_testing_48702.urls'
...
WSGI_APPLICATION = 'dwg_testing_48702.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "dwg-testing Support <support@dwg-testing-48702.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dwg_testing_48702 API",
    "DESCRIPTION": "API documentation for dwg_testing_48702 App",
    "VERSION": "v1",
}
